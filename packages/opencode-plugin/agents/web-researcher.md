...
Supply `local_transcript.markdown.path` for the chats you used as plain local-file metadata in
your handoff. Use inline code for the absolute path, never a Markdown link or `file://` URL.
